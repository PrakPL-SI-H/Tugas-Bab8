...
public class Sasando extends AlatMusikPetik implements Musik {
//child class dari class AlatMusikPetik dan implemen musik
    public Sasando(String Nama, String Bahan, String CaraPakai) {
