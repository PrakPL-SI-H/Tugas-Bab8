...
public class Main{
    public static void main(String[] args) {
        ...
        int Pilihan = 0;
        do {
            System.out.println("\t\tTOKO MUSIK EVERYWHERE");
            System.out.println("\t\t~~~~~~~~~~~~~~~~~~~~~~~~");
            System.out.println();
            System.out.println("============================");
            System.out.println("Jenis alat musik yang kami sediakan");
            ...
            switch (Pilihan) {
                case 1:
                    System.out.println();
                    System.out.println("Stock alat musik Tiup");
                    System.out.println("1. Harmonica");
                    System.out.println("2. Terompet");
                    System.out.println("3. Keluar");
                    System.out.print("Alat musik yang anda inginkan : ");
                    Pilihan = in.nextInt();
                    if (Pilihan == 1) {
                        Harmonica Ob = new 
                        Harmonica("Harmonica");
                ...
                case 2:
                    System.out.println();
                    System.out.println("Stock alat musik Gesek");
                ...
                case 3:
                    System.out.println();
                    System.out.println("Stock alat musik Petik");
